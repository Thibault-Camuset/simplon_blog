...
// Vue qui gère l'affichage de la page "Home" qui sert de page d'accueil du blog
...
<div id="content-home">
    ...
    <div id="categories-buttons">
        ...
        <div id="log-buttons">
            ...
            <a id="goto-deconnect" href="deconnect.php">Bienvenue <?php echo $_SESSION['userName']; ?>! Se déconnecter</a>
